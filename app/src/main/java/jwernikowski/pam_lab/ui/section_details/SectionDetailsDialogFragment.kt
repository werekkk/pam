package jwernikowski.pam_lab.ui.section_details
...
import jwernikowski.pam_lab.ui.song_details.EntrySwipeToDeleteCallback
import jwernikowski.pam_lab.ui.song_details.PracticeEntryAdapter
import kotlinx.coroutines.Dispatchers
import kotlinx.coroutines.launch
import kotlinx.coroutines.withContext
import java.time.LocalDateTime

class SectionDetailsDialogFragment(private val section: Section, private val onDeletePracticeEntry: (PracticeEntry) -> Unit) : DialogFragment() {
    ...
    private fun initRecyclerView() {
        ...
        val practiceEntryAdapter = PracticeEntryAdapter({})

        viewModel.practiceEntries.observe(this, Observer { practiceEntryAdapter.setEntries(it) })
        ...
        practiceEntryRecyclerView = binding.practiceEntriesRecycler.apply {
            ...
            val touchHelper = ItemTouchHelper(EntrySwipeToDeleteCallback(practiceEntryAdapter, {handleSwipeToDelete(it)}, context))
...
//        onDeletePracticeEntry(practiceEntry)
